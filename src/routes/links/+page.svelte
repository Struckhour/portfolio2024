...
<div class="max-w-2xl mx-auto text-xl text-center mb-2 font-bold">External Links</div>
<ul class="max-w-2xl mx-auto text-xl text-center"> 
    <li>
        <a href="https://www.github.com/Struckhour" target="_blank" class="underline">Github Page</a>
    </li>
    <li>
        <a href="https://www.youtube.com/@SongbirdCode" target="_blank" class="underline">Youtube Tutorials</a>
    </li>
    <li>
        <a href="https://www.linkedin.com/in/luke-mclean-559215255/" target="_blank" class="underline">LinkedIn Page</a>
    </li>
</ul>
...
<div class="max-w-2xl mx-auto text-lg text-center my-2">Music</div>
<ul class="max-w-2xl mx-auto text-lg text-center">
    <li>
        <a href="https://chambersmclean.bandcamp.com/album/what-the-sunlight-brings" target="_blank" class="underline">What the Sunlight Brings</a>
    </li>
    <li>
